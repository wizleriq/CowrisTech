...
const Page = () => {
  return (
    <section className="lg:w-full max-w-full mx-auto
      ...
      w-full h-[720px] bg-yellow-400">
      {/* Left box */}
      <div className='lg:w-full max-w-full lg:flex lg:bg-red-300 lg:h-[1000px]'>
        ...
        <h2 className='lg:text-[40px] lg:font-medium  lg:text-[#a2abb1] lg:flex lg:items-center lg:justify-center'>AbroadEx</h2></div> */}
         <div className="lg:w-full max-w-full lg:h-[890px] lg:bg-[#ffffff] lg:p-16 flex-col lg:flex lg:items-center">
          ...
          <div className='lg:w-[276px] lg:h-14 lg:bg-transparent flex flex-col justify-between item-center lg:flex lg:-mt-13
          w-[279px] h-[43px] bg-red-400'>
            {/* width: 279;
height: 23;
top: 140px;
left: 21px;
...
<div className="flex flex-col">
  ...
  <div className="lg:w-[531.93px] lg:h-10 lg:px-3 lg:text-sm lg:flex lg:justify-between lg:items-center lg:bg-transparent">
     ...
     lg:flex lg:justify-between lg:items-center lg:border-[#AAB2CC] lg:outline-none">
      ...
      alt="Profile Image"
      fill
      className="object-fill lg:w-[13px] lg:h-[9.4px] lg:justify-between lg:items-center" 
    />
    </div>
     <h2> Google</h2>
    </div>
