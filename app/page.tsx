...
export default function Home() {
  return (
    ...
    // <div className="flex flex-col lg:w-full lg:h-[1963px] w-full justify-start items-center sm:bg-[#F4FBFF] lg:bg-red-400 bg-transparent">
     <div className="flex flex-col lg:w-full xl:w-full xl:h-[2030px] 2xl:w-[1580px] 2xl:h-[2030px] lg:h-[1963px] w-full justify-start items-center sm:bg-[#F4FBFF] lg:bg-transparent bg-transparent">
      <Navbar />
      <HomePage />
