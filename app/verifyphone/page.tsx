...
const Page = () => {
 ...
 <div className='w-full max-w-full flex lg:h-[900px]'>
         ...
         <div className="lg:w-[520px] max-w-full lg:h-[500px] lg:bg-[#ffffff] lg:shadow-lg lg:p-16 flex-col lg:flex justify-center lg:items-center">
          ...
          w-full h-[68px] mt-4'>
              <h2 className='lg:text-[28.66px] font-extrabold text-[20px] lg:leading-[100%] lg:text-left'>Verify Phone Number</h2>
            <h2 className='lg:text-[14px] lg:font-medium lg:leading-[100%] lg:left mt-2 font-medium text-[13px] text-center leading-[100%]'>Enter the 6-digit code we sent to +23481 680 3456</h2>
          </div>
  ...
  {Array(6).fill("").map((_, index) => (
    ...
    >
        <h2 className='text-[#ffffff] text-[18px]'>Verify</h2>
    </button>
    </Link>
