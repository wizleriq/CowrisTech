...
const Page = () => {
  ...
  <Nav />
    ...
    <section className="lg:w-full max-w-full mx-auto lg:h-[900px] xl:h-[900px] lg:bg-green-500 lg:flex lg:flex-col
     lg:justify-center lg:items-center w-[393px] h-[720px] flex flex-col justify-center bg-white lg:px-0 px-4 items-center
     sm:px-12 sm:flex sm:justify-center
    ...
    />
      ...
      <div className='lg:w-full w-full max-w-full sm:w-[570px] flex lg:h-[900px]'>
         ...
         sm:w-[570px] lg:p-0 sm:p-8  sm:shadow-md sm:h-[400px] sm:bg-white sm:flex sm:justify-center sm:items-center">
