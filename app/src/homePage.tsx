...
//       > */}
        ...
        <main className="relative z-10 w-[250px] h-[70.59px] lg:w-[592px] lg:h-[322px] flex flex-col px-4 pt-1.5 lg:px-2 lg:pt-0">
          ...
          <div className='w-[205px] mt-1 h-10 lg:w-[430px] lg:mt-10'>
            <h2 className='text-[12px] leading-[17px] font-normal lg:text-[17.27px] lg:leading-[23px] lg:font-normal text-[#0079C6]'>
              Applying for study, work or permanent residency? We help you handle the most important steps -- all in one secure ecosystem.
            </h2>
          </div>
          <div className='flex items-center mt-1 lg:mt-14'>
            <div className='w-[74px] h-[23.6px] flex justify-center items-center bg-[#0079C6] rounded-[3px] lg:w-36 lg:h-9 lg:bg-[#0079C6] lg:border lg:border-[#0079C6]'>
              <button className='text-white font-normal text-[11.02px] leading-4 lg:text-[18.16px] lg:leading-[100%]'>
                Get Started
              </button>
            </div>
          </div>
      ...
      <main className='flex flex-col justify-between items-center mt-4 w-[340px] h-[892px] lg:w-[1090px] lg:h-[209px] lg:flex-row lg:justify-between lg:items-center lg:mt-11'>
        {cards.map((card) => (
          <div key={card.id} className="w-[340px] h-[199px] p-5 border border-[#9BD9F280] rounded-[5px] flex flex-col justify-between bg-white lg:w-[236px] lg:h-[209px] lg:shadow-lg lg:border lg:rounded-[5px] lg:flex-col lg:justify-between lg:p-5">
            ...
            <div className='mt-3.5 w-[270px] h-4 lg:w-[200px] lg:h-8 lg:-mt-4'>
              <h2 className='text-[#0079C6] text-[13px] lg:text-[13px] font-semibold lg:leading-[15px]'>{card.heading}</h2>
            </div>
